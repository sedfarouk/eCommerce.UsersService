...
{
    /// <summary>
    /// Method to handle user login use case and returns AuthenticationResponse object that contains status of login
    /// </summary>
    ...
    /// <summary>
    /// Method to handle user registration use case and returns AuthenticationResponse object that contains status of registration
    /// </summary>
    /// <param name="loginRequest"></param>
    /// <returns></returns>
